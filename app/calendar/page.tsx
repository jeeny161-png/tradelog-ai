...
import { LanguageToggle, getEmotionLabel, useLanguage } from '@/lib/i18n'
                ...
                <div key={trade.id} className="rounded-xl border border-white/[0.06] bg-[#0f1117] p-4">
                  <div className="mb-3 flex items-start justify-between gap-3">
                    <div className="min-w-0">
                      ...
                      <div className="mt-1 break-words text-xs text-slate-500">{trade.direction === 'L' ? t.long : t.short} · {trade.quantity} lot · {getEmotionLabel(trade.emotion, language)}</div>
                    </div>
